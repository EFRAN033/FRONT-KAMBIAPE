        ...
        <div class="grid grid-cols-12 gap-8">
          ...
          <article class="col-span-12 lg:col-span-9">
            <header class="mb-8">
              ...
              [cite_start]<p class="mt-2 text-slate-600 max-w-prose">En KambiaPe, la confianza se construye[cite: 2]. [cite_start]Proteger tus datos es parte esencial de nuestro compromiso con una comunidad transparente, solidaria y segura[cite: 3].</p>
            </header>
            ...
            <section id="filosofia" class="scroll-mt-28 max-w-prose">
              ...
              [cite_start]<p class="mt-4 leading-8">KambiaPe nace para impulsar una nueva forma de economía colaborativa[cite: 6]. [cite_start]Entendemos que cada dato personal que compartes representa un acto de confianza, y por eso lo tratamos con el máximo cuidado[cite: 7].</p>
            </section>
            ...
            <section id="recopilacion" class="scroll-mt-28 max-w-prose">
              ...
              [cite_start]<p class="mt-4 leading-8">Cuando te unes a KambiaPe, recopilamos solo la información necesaria para brindarte una experiencia segura y personalizada[cite: 9]. Esto incluye:</p>
              <ul class="mt-4 space-y-2 leading-8 list-disc pl-5 marker:text-pink-600">
                [cite_start]<li>Tu nombre completo[cite: 10].</li>
                [cite_start]<li>Número de DNI, para garantizar la seguridad en la comunidad[cite: 11].</li>
                [cite_start]<li>Correo electrónico y número de contacto[cite: 12].</li>
                [cite_start]<li>Ubicación general (ciudad o distrito, sin precisar dirección exacta)[cite: 13].</li>
                [cite_start]<li>Descripción de los productos o servicios que ofreces o solicitas[cite: 14].</li>
              </ul>
            </section>
            ...
            <section id="finalidad" class="scroll-mt-28 max-w-prose">
              ...
              [cite_start]<p class="mt-4 leading-8">Usamos tu información con propósitos claros, éticos y limitados[cite: 16]. [cite_start]Tu información nunca será utilizada con fines comerciales ajenos a KambiaPe ni se compartirá para publicidad externa[cite: 22].</p>
               <ul class="mt-2 space-y-2 leading-8 list-disc pl-5 marker:text-pink-600">
                  [cite_start]<li>Facilitar los intercambios entre usuarios[cite: 17].</li>
                  [cite_start]<li>Mantener la comunicación contigo sobre actualizaciones o mejoras[cite: 18].</li>
                  [cite_start]<li>Garantizar la seguridad y el correcto funcionamiento de KambiaPe[cite: 19].</li>
                  [cite_start]<li>Elaborar reportes internos para optimizar la experiencia[cite: 20].</li>
                  [cite_start]<li>Enviarte información relevante, solo si lo autorizas[cite: 21].</li>
                </ul>
            </section>
            ...
            <section id="proteccion" class="scroll-mt-28 max-w-prose">
              ...
              [cite_start]<p class="mt-4 leading-8">KambiaPe implementa medidas técnicas y administrativas para proteger tus datos frente a accesos no autorizados, pérdida o alteración[cite: 25]. [cite_start]Nuestro equipo actúa bajo principios de confidencialidad, ética y respeto digital, siguiendo las normas de la <strong>Ley N.º 29733, Ley de Protección de Datos Personales del Perú</strong>[cite: 26].</p>
            </section>
            ...
            <section id="derechos" class="scroll-mt-28 max-w-prose">
              ...
              [cite_start]<p class="mt-4 leading-8">Tienes el control total sobre tu información[cite: 28]. En cualquier momento puedes:</p>
              <ul class="mt-2 space-y-2 leading-8 list-disc pl-5 marker:text-pink-600">
                [cite_start]<li>Acceder a tus datos personales[cite: 29].</li>
                [cite_start]<li>Solicitar su corrección o actualización[cite: 30].</li>
                [cite_start]<li>Pedir la eliminación definitiva de tu cuenta y datos[cite: 31].</li>
                [cite_start]<li>Retirar tu consentimiento para recibir comunicaciones[cite: 32].</li>
              </ul>
              [cite_start]<p class="mt-4 leading-8">Solo escríbenos a <a href="mailto:kambiapex@gmail.com" class="font-medium text-pink-600 hover:text-pink-700">kambiapex@gmail.com</a> y atenderemos tu solicitud[cite: 33].</p>
            </section>
            ...
            <section id="comparticion" class="scroll-mt-28 max-w-prose">
              ...
              [cite_start]<p class="mt-4 leading-8">KambiaPe no comparte, vende ni alquila tus datos personales[cite: 35]. [cite_start]Solo podríamos compartir información en casos de requerimiento por una autoridad legal o judicial, o si es necesario para resolver conflictos y garantizar la seguridad de los usuarios[cite: 36, 37].</p>
            </section>
            ...
            <section id="cookies" class="scroll-mt-28 max-w-prose">
              ...
              [cite_start]<p class="mt-4 leading-8">KambiaPe utiliza cookies para recordar tus preferencias y mejorar tu experiencia, sin rastrearte[cite: 39]. [cite_start]Puedes desactivarlas en cualquier momento desde la configuración de tu navegador[cite: 40].</p>
            </section>
             ...
             <hr class="my-8 border-slate-200"/>
              ...
              <section id="actualizacion" class="scroll-mt-28 max-w-prose">
                ...
                [cite_start]<p class="mt-4 leading-8">Podemos actualizar esta Política de Privacidad cuando sea necesario[cite: 42]. [cite_start]Te avisaremos siempre de manera visible dentro de la plataforma antes de que las modificaciones entren en vigor[cite: 43].</p>
              </section>
  
            <hr class="my-10 border-slate-200"/>
  
            <div class="max-w-prose">
              [cite_start]<p class="text-sm text-slate-600">Gracias por confiar en KambiaPe, donde la tecnología se encuentra con la solidaridad y la privacidad es parte del respeto mutuo[cite: 48].</p>
