<template>
  <div class="relative min-h-screen bg-slate-100 dark:bg-slate-900 font-sans antialiased flex flex-col">
...
// --- Animación de mouse (ELIMINADA) ---
// (Toda la lógica de handleMouseMove, shape1, shape2, etc., ha sido borrada)
</script>
