<template>
    <div class="relative min-h-screen bg-slate-100 dark:bg-slate-900 font-sans antialiased overflow-hidden flex flex-col" @mousemove="handleMouseMove">
        ...
        <main class="relative z-10 flex-grow flex items-center justify-center py-12 sm:py-20">
                    ...
                    <div class="branding-stage">
                        ...
                        <div class="text-center lg:text-left mt-8">
                           <h1 class="main-headline">
                                Construye la Reputación que te Mereces.
                            </h1>
                            <p class="sub-headline">
                                Tu tiempo y tus intercambios son valiosos. Invierte en las herramientas que te garantizan el mejor retorno y te posicionan como un miembro de confianza.
                            </p>
                        </div>
                    </div>
                    ...
                    <div class="selection-stage">
                        ...
                        <div class="benefits-grid">
                            <div class="benefit-item">
                                <svg class="benefit-icon" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13 7h8m0 0v8m0-8l-8 8-4-4-6 6"></path></svg>
                                <span class="benefit-text">Maximiza tu Alcance</span>
                            </div>
                            <div class="benefit-item">
                               <svg class="benefit-icon" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12l2 2 4-4m5.618-4.016A11.955 11.955 0 0112 2.944a11.955 11.955 0 01-8.618 3.04A12.02 12.02 0 003 9c0 5.591 3.824 10.29 9 11.622 5.176-1.332 9-6.03 9-11.622 0-1.042-.133-2.052-.382-3.016z"></path></svg>
                                <span class="benefit-text">Refuerza tu Perfil</span>
                            </div>
                             <div class="benefit-item">
                                <svg class="benefit-icon" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 8c-1.657 0-3 .895-3 2s1.343 2 3 2 3 .895 3 2-1.343 2-3 2m0-8c1.11 0 2.08.402 2.599 1M12 8V7m0 1v.01"></path></svg>
                                <span class="benefit-text">Acelera tus Metas</span>
                            </div>
                        </div>
                    </div>
                </div>
...
const plans = [
    { name: 'Básico', amount: 2, price: 'S/ 1.00', avatar: avatarBasico, tagline: 'Primeros Pasos' },
    { name: 'Popular', amount: 5, price: 'S/ 2.00', avatar: avatarPopular, tagline: 'Crecimiento Acelerado' },
    { name: 'Pro', amount: 10, price: 'S/ 5.00', avatar: avatarPro, tagline: 'Líder Consolidado' }
];
...
// Lógica de Parallax (sin cambios)
...
<style scoped>
/* Estilos de Fondo y Layout Base */
...
.store-layout { @apply grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-16 items-center; }
...
.selection-stage { @apply relative flex flex-col items-center lg:items-start h-full p-6 sm:p-8 rounded-2xl text-center lg:text-left; @apply bg-white/60 dark:bg-slate-800/60 backdrop-blur-xl border border-white/30 dark:border-slate-700; min-height: 70vh; }
.balance-display { @apply text-base font-medium mb-6 w-full pb-4 border-b border-slate-200 dark:border-slate-700; @apply flex flex-col items-center lg:items-start; }
.no-kambitos-warning { @apply w-full text-center lg:text-left mb-2 text-sm font-semibold text-sky-600 dark:text-sky-400; }
.plan-selector { @apply w-full flex flex-col items-center lg:items-start gap-3; }
.plan-name { @apply text-5xl md:text-6xl font-extrabold text-transparent cursor-pointer transition-all duration-300 relative; -webkit-text-stroke: 2px #d1d5db; }
.dark .plan-name { -webkit-text-stroke: 2px #4b5563; }
.plan-name:hover { -webkit-text-stroke: 2px #be185d; }
.plan-name.active { @apply text-[#d7037b]; -webkit-text-stroke: 2px transparent; }
.details-flow { @apply mt-auto pt-6 w-full flex flex-col items-center lg:items-start; }
...
.purchase-button { @apply w-full bg-[#d7037b] text-white font-bold py-3.5 px-6 rounded-lg text-lg transition-all duration-300; animation: pulse-glow 3s infinite ease-in-out; }
.purchase-button:hover { @apply bg-pink-700; transform: scale(1.03) translateY(-1px); animation-play-state: paused; }
.benefits-grid { @apply w-full grid grid-cols-3 gap-4 mt-auto pt-6 border-t border-slate-200 dark:border-slate-700; }
.benefit-item { @apply flex flex-col items-center gap-2 text-center; }
.benefit-icon { @apply w-8 h-8 text-[#d7037b] opacity-80; }
.benefit-text { @apply text-xs text-slate-600 dark:text-slate-300 font-medium; }
