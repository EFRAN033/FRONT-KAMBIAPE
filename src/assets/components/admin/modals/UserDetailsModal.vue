            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div class="bg-slate-50 p-4 rounded-lg">
                ...
                <ul class="space-y-2 text-sm">
                  ...
                  <li class="flex items-center"><svg class="h-5 w-5 mr-3 text-slate-400" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M17.657 16.657L13.414 20.9a1.998 1.998 0 01-2.827 0l-4.244-4.243a8 8 0 1111.314 0z" /><path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M15 11a3 3 0 11-6 0 3 3 0 016 0z" /></svg><span class="text-slate-600">{{ user.ubicacion || 'No especificada' }}</span></li>
                </ul>
              </div>
              <div class="bg-slate-50 p-4 rounded-lg">
                <h3 class="font-semibold text-slate-800 mb-3">Estadísticas</h3>
                 <ul class="space-y-2 text-sm">
                  ...
                  <li class="flex items-center"><svg class="h-5 w-5 mr-3 text-slate-400" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M11.049 2.927c.3-.921 1.603-.921 1.902 0l1.519 4.674a1 1 0 00.95.69h4.915c.969 0 1.371 1.24.588 1.81l-3.976 2.888a1 1 0 00-.363 1.118l1.52 4.674c.3.921-.755 1.688-1.539 1.118l-3.975-2.888a1 1 0 00-1.176 0l-3.976 2.888c-.783.57-1.838-.197-1.539-1.118l1.52-4.674a1 1 0 00-.363-1.118L2.98 9.82c-.783-.57-.38-1.81.588-1.81h4.914a1 1 0 00.95-.69L11.049 2.927z" /></svg> <span class="text-slate-600"><strong>{{ user.reputation ? user.reputation.toFixed(1) : 'N/A' }}</strong> de Reputación</span></li>
                </ul>
              </div>
...
const formatDateTime = (dateTimeString) => {
  ...
  try {
    ...
    // Se usa el timezone del navegador del usuario para mostrar la hora local
